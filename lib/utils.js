...
/**
 * Returns the cluster of a security groups given its name
 * 
 * @param {String}
...
module.exports.iterateOverNodes = function(options, selector, iterator, done) {
  ...
  pkgcloud.compute.createClient(options.pkgcloud).getServers({},
...
module.exports.iterateOverSecurityGroups = function(options, selector,
  ...
  pkgcloud.network.createClient(options.pkgcloud).getSecurityGroups(
