...
/**
 * Returns true if the container is to be processed (that is, either the
 * nodetype Grunt option is not defined, or it si defined and the current node
 * and image contain such nodetype
 * 
 * @param {String}
 *          grunt Grunt object
 * @param {String}
 ...
 */
module.exports.isContainerToBeProcessed = function(grunt, nodeType, imageName) {
  return !grunt.option("nodetype")
