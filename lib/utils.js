 ...
 *          opt1 Docker options
 * @param {Object}
 *          opt2 Options object as per sensistive.json)
 *
 */
module.exports.addDockerHeaders = function(opt1, opt2) {
  return _.extend(opt1, {headers: opt2.docker.client && opt2.docker.client.headers});
};
...
module.exports.iterateOverClusterContainers = function(grunt, options,
  ...
  module.exports.iterateOverClusterNodes(options, function(node, next) {
    (new Docker(module.exports.addDockerHeaders(node.docker, options))).listContainers({
      all : true
