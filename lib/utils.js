...
module.exports.iterateOverNodes = function(options, selector, iterator, done) {
  ...
  if (_.isUndefined(options.clusterAliases)) {
    ...
    dockerClient = {
      ...
      dockerPort = function(currNode) {
        var selNode= _.find(options.clusterAliases, function(node) {
          return currNode.id == node.id;
        });
        
        return selNode && selNode.addresses ? addresses.dockerPort : 2375;
      };
      sshHost = function(currNode) {
        return "127.0.0.1";
      };
      sshPort = function(currNode) {
        ...
        return selNode && selNode.addresses ? addresses.sshPort : 22;
      };
      sshUsername= function(currNode) {
